...
def main():
    ...
    cmd = [
        sys.executable, "extract_real_contrast_limufs.py",
        "--sae-model-path", "exp/sod/ape/sae_models/sae_layer_2048d.pt",
        "--activations-path", "exp/sod/ape/activations/activations_layers_3.h5",
        "--interpretations-path", "layer_interpretations/enhanced_diversity_report_layer3.json",
        "--feature-a", "182",
        "--feature-b", "1743",
        "--activation-threshold", "2.0",
        "--output-dir", "real_contrast_limufs_182_vs_1743"
    ]
    ...
    cmd = [
        sys.executable, "test_real_contrast_interventions.py",
        "--model-path", "exp/sod/ape/checkpoints/best_model.pt",
        "--contrast-limuf-path", "real_contrast_limufs_182_vs_1743/limufs.pt",
        "--output-dir", "real_contrast_interventions_182_vs_1743",
    ...
    try:
        cmd = [
            ...
            "--results-dir", "real_contrast_interventions_182_vs_1743",
            "--contrast-name", "steady_pulse_vs_melodic_sequences"
        ]
